...
class IncomeSerializer(serializers.ModelSerializer, DateSerializeHelper):
    class Meta:
        model = Income
        fields = ['id', 'category', 'category_text', 'amount', 'date', 'destination', 'year', 'month', 'month_text', 'notes']
...
class TransactionSerializer(serializers.ModelSerializer, DateSerializeHelper):
    class Meta:
        model = Transaction
        fields = ['id', 'category', 'category_text', 'subcategory', 'subcategory_text', 'is_payment', 'is_deleted', 'is_saving', 'is_expense', 'payment_method', 'payment_method_text', 'amount', 'date', 'destination', 'alias', 'year', 'month', 'month_text', 'notes', 'delete_reason']
