...
from investments.services.holding_service import HoldingService, HoldingDaemonService
...
class HoldingDaemonView(APIView):
    ...
    def get(self, request):
        try:
            ...
            return Response({'data': None, 'status': False, 'message': e},  status=status.HTTP_500_INTERNAL_SERVER_ERROR)
