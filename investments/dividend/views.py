...
from investments.dividend.service.dividend_service import DividendService, DividendDaemonService
    ...
    def get(self, request):
        try:
            ...
            if task == 'refresh-dividend-payments':
                ...
                return Response({'data': None, 'message': 'Invalid task', 'status': False}, status=status.HTTP_400_BAD_REQUEST)
        except Exception as e:
