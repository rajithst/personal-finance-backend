...
class TestStockPurchaseHistoryApiView:
    def test_stock_purchase_history_retrieval_success(self, mock_stock_purchase_service, api_client, authenticate):
        authenticate()
    ...
    def test_stock_purchase_history_retrieval_failure(self, mock_stock_purchase_service, api_client, authenticate):
        authenticate()
