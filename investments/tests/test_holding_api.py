...
class TestHoldingView:
    ...
    def test_get_holdings_success(self, mock_holding_service, api_client, authenticate):
    ...
    def test_get_holdings_failure(self, mock_holding_service, api_client, authenticate):
        authenticate()
